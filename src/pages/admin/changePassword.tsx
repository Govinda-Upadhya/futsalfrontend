...
import { Mail, Shield, Send, ArrowLeft, CheckCircle, Activity } from "lucide-react";
        ...
        {!isSubmitted ? (
          <>
            <div className="text-center mb-6">
              ...
              <p className="text-emerald-600">We'll send you a reset link to your email</p>
            </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              ...
              <div className="relative">
                ...
                <div className="relative">
                  <Mail className="absolute left-3 top-1/2 transform -translate-y-1/2 text-emerald-500" size={20} />
                  <input
                    type="email"
                    {...register("email", { 
          ...
          <div className="text-center py-6">
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-emerald-600 mt-4">Redirecting you to homepage...</p>
            </div>
          </div>
        )}
      </div>
