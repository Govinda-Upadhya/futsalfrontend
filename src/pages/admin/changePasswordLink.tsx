  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-100 to-lime-100 p-4 flex items-center justify-center relative overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full overflow-hidden z-0">
        ...
        {/* Floating icons */}
        <Key className="absolute top-20 right-10 text-green-300 opacity-30 animate-bounce" size={40} />
        <Lock className="absolute bottom-40 left-10 text-green-300 opacity-30 animate-float" size={40} />
      </div>
      ...
      <div className="bg-white p-6 sm:p-8 rounded-2xl shadow-xl w-full max-w-md border border-green-200 relative z-10 transform transition-all duration-500 hover:shadow-2xl">
        ...
        >
          <ArrowLeft className={`mr-1 transition-transform duration-300 ${isHovered ? 'transform -translate-x-1' : ''}`} size={18} />
          Back
        </button>
        ...
        {!isSuccess ? (
          <>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
              ...
              <div className="mb-5 relative">
                <label className="block text-green-800 font-medium mb-2">New Password</label>
                  ...
                  <div className="mt-2">
                      ...
                      <div className="w-full bg-green-100 rounded-full h-2.5">
                        <div 
                          ...
                          style={{ 
                            ...
                            backgroundColor: getPasswordStrength() < 50 ? '#ef4444' : 
                                            getPasswordStrength() < 75 ? '#f59e0b' : '#10b981'
                          }}
                        ></div>
                      </div>
                    </div>
                    <p className="text-xs text-green-600">
                      Password strength: {
                        ...
                        getPasswordStrength() < 75 ? 'Medium' : 'Strong'
                      }
                    </p>
                  </div>
                )}
                ...
                {errors.password && (
                  <p className="text-red-500 text-sm mt-2 flex items-center">
                    <span className="w-4 h-4 bg-red-500 rounded-full flex items-center justify-center text-white mr-1" style={{ fontSize: '10px' }}>!</span>
          ...
          <div className="text-center py-6">
            ...
            <div className="mt-6">
              ...
              <p className="text-sm text-green-600 mt-4">Redirecting you to homepage...</p>
            </div>
          </div>
        )}
      </div>
