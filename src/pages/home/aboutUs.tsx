...
const AboutUs: React.FC = () => {
  ...
  const stats = [
    ...
    { icon: MapPin, value: 50, label: "Premium Grounds" },
    { icon: Calendar, value: 5000, label: "Monthly Bookings" },
  ...
  const values = [
    {
      icon: Target,
      title: "Our Mission",
      description: "To revolutionize sports accessibility by connecting players with premium facilities through innovative technology."
    },
    {
      icon: Heart,
      title: "Our Passion",
      description: "We're driven by our love for sports and commitment to creating unforgettable playing experiences for everyone."
    },
    {
      icon: Shield,
      title: "Our Promise",
      description: "We guarantee seamless bookings, secure payments, and exceptional support for all our users."
    },
    {
      icon: Globe,
      title: "Our Vision",
      description: "To become the world's most trusted platform for sports enthusiasts and facility owners alike."
    }
  ];
          ...
          if (entry.isIntersecting) {
            ...
            stats.forEach((stat, index) => {
              ...
              const timer = setInterval(() => {
                step += 1;
                const currentValue = Math.min(Math.floor(increment * step), stat.value);
                
                setAnimatedStats(prev => {
                  const newStats = [...prev];
                  newStats[index] = index === 3 ? 
                    (currentValue === stat.value ? stat.value : Number((increment * step).toFixed(1))) : 
                    currentValue;
                  return newStats;
                });
      ...
      <section className="py-16 bg-gradient-to-r from-emerald-600 to-green-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          ...
          <p className="text-lg md:text-xl mb-0 max-w-2xl mx-auto">
            Revolutionizing the way players connect with premium sports facilities
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {stats.map((stat, index) => (
              <div key={index} className="text-center group" data-aos="fade-up" data-aos-delay={index * 100}>
                <div className="w-16 h-16 bg-emerald-100 rounded-full flex items-center justify-center mx-auto mb-4 group-hover:bg-emerald-600 transition-all duration-500 group-hover:scale-110">
                  <stat.icon className="h-8 w-8 text-emerald-600 group-hover:text-white transition-colors duration-300" />
                </div>
                <h3 className="text-3xl font-bold text-gray-900 mb-2">
                  {index === 3 ? animatedStats[index] : animatedStats[index].toLocaleString()}
                  {index === 3 && '/5'}
                </h3>
            ...
            <div data-aos="fade-right">
              ...
              <div className="space-y-4 text-gray-700">
                <p className="text-lg leading-relaxed">
                  Founded in 2023, ThangGo emerged from a simple observation: sports enthusiasts 
                  struggled to find and book quality playing facilities, while ground owners faced 
                  challenges in managing their bookings efficiently.
                </p>
                <p className="text-lg leading-relaxed">
                  What started as a solution to connect players with nearby grounds has evolved into 
                  a comprehensive platform that serves thousands of users across multiple cities, 
                  offering seamless booking experiences and building vibrant sports communities.
                </p>
                <p className="text-lg leading-relaxed">
                  Today, we're proud to be at the forefront of sports technology innovation, 
                  continuously enhancing our platform to deliver exceptional value to both players 
                  and facility owners.
                </p>
              </div>
            </div>
              ...
              <div className="bg-emerald-600 rounded-2xl p-6 text-white transform rotate-2 hover:rotate-0 transition-transform duration-500">
                <div className="transform -rotate-2">
                  ...
                  <blockquote className="text-xl italic mb-4">
                    "ThangGo has transformed how we manage our facilities and serve our players. 
      ...
      <section className="py-20 bg-gradient-to-r from-emerald-600 to-green-700 text-white relative overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10" data-aos="zoom-in">
          ...
          <p className="text-xl mb-8 max-w-2xl mx-auto">
            Whether you're a player looking for the perfect ground or a facility owner wanting to reach more customers, 
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-6xl mx-auto px-4">
          <div className="text-center mb-16" data-aos="fade-up">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              The passionate individuals behind ThangGo's success
            </p>
          </div>
              ...
              >
                <div className="relative mb-6 overflow-hidden rounded-2xl">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/70 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center pb-4">
                    <div className="text-white opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-200">
                      <div className="flex justify-center space-x-4">
                        <div className="w-8 h-8 bg-white/20 rounded-full flex items-center justify-center hover:bg-emerald-500 cursor-pointer">
                ...
                <h3 className="text-xl font-semibold text-gray-900 mb-2 group-hover:text-emerald-600 transition-colors duration-300">{member.name}</h3>
